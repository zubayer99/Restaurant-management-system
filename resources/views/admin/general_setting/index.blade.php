                ...
                <form class="form-horizontal" id="updateGeneralSetting" method="POST">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                            @if($item->logo != '')
                            <img id="logo" src="{{asset('public/site-images/'.$item->logo)}}" alt="" width="80px" height="80px">
                            @else
                            <img id="logo" src="{{asset('public/site-images/default.png')}}" alt="" width="80px" height="80px">
                            @endif
                        </div>
                    </div>
                    <div class="row clearfix">
